...
async def crawl_parallel_with_requests(
    urls: List[str], tracker: Optional[CrawlProgressTracker] = None, max_concurrent: int = 5
):
...
def get_clinia_docs_urls() -> List[str]:
    """Get URLs from clinia docs sitemap."""
...
def clear_existing_records():
    ...
    try:
        ...
        print("Cleared existing clinia_doc_pages records from site_pages")
        return result
    except Exception as e:
